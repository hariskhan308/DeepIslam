...
function Revelation_Order() {
  ...
  const playAudio = () => {
    if (isPlaying) {
      ...
      AudioRef.current.play(); // Play if not playing
      setIsPlaying(true);
  ...
  return (
    <div className="mt-32 w-full pt-10">
      ...
      <div className="flex flex-col items-center w-full px-4 py-10 border-b-[.00001px]">
        ...
        {/* Recitation */}
        {active === 'Recitation' && (
          <div className="flex border-b flex-col items-center text-xl leading-loose w-full md:w-2/3 lg:w-1/2 xl:w-[40%] text-center text-white px-3 py-6">
            <div className="text-2xl leading-[2.8rem] surah-name">
              <p className="flex justify-center items-center mb-5">
                <span className="ayah-circle">١</span>
                <svg
              ...
              <span className="ayah-circle">٢</span>
              الرَّحْمَٰنِ الرَّحِيمِ
              <span className="ayah-circle">٣</span>
              مَٰلِكِ يَوْمِ الدِّينِ
              <span className="ayah-circle">٤</span>
              إِيَّاكَ نَعْبُدُ وَإِيَّاكَ نَسْتَعِينُ
              <span className="ayah-circle">٥</span>
              ٱهْدِنَا الصِّرَٰطَ الْمُسْتَقِيمَ
              <span className="ayah-circle">٦</span>
              صِرَٰطَ الَّذِينَ أَنْعَمْتَ عَلَيْهِمْ غَيْرِ ٱلْمَغْضُوبِ
              عَلَيْهِمْ وَلَا ٱلضَّآلِّينَ
              <span className="ayah-circle">٧</span>
            </div>
          </div>
        )}
        {
          ...
          <div className="px-0 sm:px-10 md:px-20 lg:px-32 w-full">
            {verses.map((verse) => (
              ...
              >
                ...
                {/* Right: Arabic Verse + Translations */}
