...
function JuzDiscription() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await apiClient.get(`Juz/${id}`);
  ...
  // ];
  return (
    <div className="mt-32 w-full pt-10">
      ...
      <div className="flex flex-col items-center w-full px-4 py-10 border-b-[.00001px]">
        ...
        <h1
          ...
          className="surah-name border-b pb-2 text-white mb-5 text-center"
        >
          {id}
        </h1>
        {/* Surah Info */}
        <div className="flex gap-32 justify-between">
          <h2
            ...
            className="flex cursor-pointer hover:bg-[grey] rounded px-2 items-center gap-2 maven text-lg text-gray-300 my-5"
          >
            {active === 'Recitation' && (
              <>
                <LuBadgeInfo />
          ...
          <h2
            onClick={playAudio}
            className="flex cursor-pointer items-center justify-center gap-2 maven text-lg text-gray-300 my-5"
          >
            {active === 'Recitation' &&
              (isPlaying ? (
                <>
        ...
        {/* Recitation */}
        {active === 'Recitation' && (
          <div className="flex  flex-col items-center  text-xl leading-loose w-full md:w-2/3 lg:w-1/2 xl:w-[45%] text-center text-white  py-6">
            <div
              ref={containerRef}
              className="w-full h-[75vh] overflow-y-auto scroll-smooth"
            >
              {/* Bismillah design for every sorah */}
              <p className="flex  justify-evenly border-[.1px] border-[#4A5565] items-center mb-5 pb-2">
                <img
                  src="/quran.png"
                  alt=""
              ...
              {[...new Set(surahDetails.map((ayah) => ayah.page))].map(
                (pageNumber) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`text-2xl px-2 text-justify text-align-last tracking-wider leading-loose quran-UTMNI text-gray-100`}
                      >
                        {pageVerses.map((ayah) => (
        ...
        {active === 'Translation' && (
          <>
            <div className="flex justify-center sm:flex-row flex-col  sm:justify-between w-full px-0 sm:px-10 md:px-20 lg:px-32 maven">
              ...
              <div className="flex sm:flex-col flex-rew gap-x-4 mt-5 sm:mt-0 justify-between sm:gap-y-2 maven cursor-pointer">
              ...
              >
                <div className="flex flex-col items-center lg:items-start space-y-4 text-gray-400">
                  <div className="flex items-center text-start flex-row lg:flex-col space-x-3 lg:space-x-0 lg:space-y-4 p-2">
                    <span className="maven p-2">{verse.id}:1</span>
                    {icons.map((item) => (
                ...
                <div className="w-full flex flex-col md:gap-y-0 gap-y-5 justify-between">
                  <div className="text-end">
                    <span className="surah-name">
                      <span className="ayah-circle">{verse.id}</span>
                      {verse.arabic}
                    </span>
                  </div>
